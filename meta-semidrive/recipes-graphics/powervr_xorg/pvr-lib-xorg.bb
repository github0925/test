...
S = "${WORKDIR}"
DEPENDS = "libdrm cairo mtdev libevdev"
...
FILESEXTRAPATHS_prepend := "${TOPDIR}/../prebuilt/gpu/powervr_xorg:"
...
INSANE_SKIP_libvulkan += "dev-so ldflags file-rdeps build-deps"
INSANE_SKIP_${PN}-tests += "ldflags file-rdeps build-deps"
