...
EXTERNALSRC = "${TOPDIR}/../source/vendor/gstreamer-1.14.4/gst-omx"
EXTERNALSRC_BUILD = "${WORKDIR}/gst-omx-${PV}"

DEPENDS = "gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-bad libdrm"
