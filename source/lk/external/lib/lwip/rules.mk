...
LWIP_IP_TYPE := IPV4
GLOBAL_DEFINES += LWIP_DEBUG
MODULE_COMPILEFLAGS += -Wno-unused-but-set-variable -Wno-unused-variable

ifeq ($(LWIP_IP_TYPE),IPV4)
GLOBAL_DEFINES += LWIP_IPV4=1
...
MODULE_SRCS += \
	...
	$(LOCAL_DIR)/apps/lwiperf/lwiperf.c \
