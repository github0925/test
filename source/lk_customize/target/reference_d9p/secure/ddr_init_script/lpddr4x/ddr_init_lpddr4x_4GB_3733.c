//DT_3733_PhyV_0xd_DBI_1_DM_1_PDDS_5_DQODT_4_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x19_VDQ_0x9_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0x0_RK_2_CH_2_ECC_0_TRAINTYPE_12_SIZE_S4GB
//2021-05-31 19:44:50
//
DDR_INFO("DT_3733_PhyV_0xd_DBI_1_DM_1_PDDS_5_DQODT_4_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x19_VDQ_0x9_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0x0_RK_2_CH_2_ECC_0_TRAINTYPE_12_SIZE_S4GB\n");
CFG_DDR_CLK(FREQ_DDR_3733);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DERATEEN_OFF, 0x1313);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x7100a8);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x540000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc002071f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0xb7000a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x8d05);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x640036);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x1e263f28);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x70738);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x8121b1a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0xd0e006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x11040a11);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x2050e0e);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG6_OFF, 0x20b0008);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG7_OFF, 0x502);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG13_OFF, 0xd100002);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG14_OFF, 0x4e1);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG15_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL0_OFF, 0x53a5001c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL1_OFF, 0x2f00070);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL2_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ODTCFG_OFF, 0x6070e74);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x49f820c);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0x1f0c);
...
DDR_INFO("TYPE: lpddr4x 3733, train1d2d with ca, seta, dm, dbi");
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_CALUCLKINFO_P0_OFF, 0x3a5);
...
DDR_W32(APB_DDRPHY_BASE+0x54019*4, 0x3664);
...
DDR_W32(APB_DDRPHY_BASE+0x5401f*4, 0x3664);
...
DDR_W32(APB_DDRPHY_BASE+0x54032*4, 0x6400);
DDR_W32(APB_DDRPHY_BASE+0x54033*4, 0xe936);
...
DDR_W32(APB_DDRPHY_BASE+0x54038*4, 0x6400);
DDR_W32(APB_DDRPHY_BASE+0x54039*4, 0xe936);
...
DDR_INFO("LPDDR4X_DT_3733_TRAIN1D2D_WITH_CA_SETA_DM_DBI: set_msgblock_2d");
DDR_W32(APB_DDRPHY_BASE+0x54000*4, 0x20);
DDR_W32(APB_DDRPHY_BASE+0x54001*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54002*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54003*4, 0xe94);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_DBYTEDLLMODECNTRL_OFF, 0x2);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY0_P0_OFF, 0x74);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY1_P0_OFF, 0xe9);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY2_P0_OFF, 0x91c);
