...
#define SYS_TIMER RES_TIMER_TIMER8
#define SYS_TIMER_HF_CLK_FREQ CKGEN_TIMER8
#define SYS_TIMER_LF_CLK_FREQ TIMER8_LF_FREQ

#define VCE_ID_GENERAL_SUPPORT_PKA RES_CE_MEM_CE2_VCE4
...
/*begin:int redefine*/
#define UART_INT   IRQ_GIC5_UART10_INTR_NUM
#define TIMER_INT  IRQ_GIC5_TIMER3_CHN_A_IRQ_NUM
#define MU_MESSAGE_READY_INT  (IRQ_GIC5_MU_MU_MESSAGE_READY_INT_O4_NUM)
