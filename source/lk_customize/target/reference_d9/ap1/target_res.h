...
#define GIC_RES_ID RES_GIC_GIC4
#define GIC_BASE GIC4_BASE
#define GICBASE(n)  (GIC4_BASE)
#define GICD_OFFSET (0x1000)
#define GICC_OFFSET (0x2000)

/*begin:int redefine*/
#define UART_INT   IRQ_GIC2_UART15_INTR_NUM
#define TIMER_INT  IRQ_GIC2_TIMER4_CHN_A_IRQ_NUM
