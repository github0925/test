//DT_1600_PS_1_PhyV_0xf_DBI_1_DM_1_PDDS_5_DQODT_4_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x1f_VDQ_0x1c_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_1_CH_2_PUCAL_1_RSVD00_0x0_ECC_0_TRAINTYPE_12_SIZE_S2GB
//2021-07-16 14:35:52
DDR_INFO("DT_1600_PS_1_PhyV_0xf_DBI_1_DM_1_PDDS_5_DQODT_4_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x1f_VDQ_0x1c_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_1_CH_2_PUCAL_1_RSVD00_0x0_ECC_0_TRAINTYPE_12_SIZE_S2GB\n");
CFG_DDR_CLK(FREQ_DDR_1600);
//DDR_SEQ_VERSION_PRINT(0x0001000);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x300034);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x180000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc001030f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0x4f000a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x8d05);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x240012);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x10101a11);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x30418);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x408110f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0x606006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x8040408);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x2030606);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL0_OFF, 0x5190000c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL1_OFF, 0x1400070);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL2_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ODTCFG_OFF, 0x6070e74);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x48b8204);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0xb04);
...
DDR_INFO("TYPE: lpddr4 1600, train1d2d with ca, seta, dm, dbi");
...
DDR_INFO("LPDDR4_DT_1600_TRAIN1D2D_WITH_CA_SETA_DM_DBI: set_msgblock");
...
DDR_W32(APB_DDRPHY_BASE+0x54019*4, 0x1224);
DDR_W32(APB_DDRPHY_BASE+0x5401a*4, 0xeb);
DDR_W32(APB_DDRPHY_BASE+0x5401b*4, 0x5f24);
DDR_W32(APB_DDRPHY_BASE+0x5401c*4, 0x1c08);
DDR_W32(APB_DDRPHY_BASE+0x5401d*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x5401e*4, 0x1e);
DDR_W32(APB_DDRPHY_BASE+0x5401f*4, 0x1224);
DDR_W32(APB_DDRPHY_BASE+0x54020*4, 0xeb);
DDR_W32(APB_DDRPHY_BASE+0x54021*4, 0x5f24);
DDR_W32(APB_DDRPHY_BASE+0x54022*4, 0x1c08);
...
DDR_W32(APB_DDRPHY_BASE+0x54032*4, 0x2400);
DDR_W32(APB_DDRPHY_BASE+0x54033*4, 0xeb12);
DDR_W32(APB_DDRPHY_BASE+0x54034*4, 0x2400);
DDR_W32(APB_DDRPHY_BASE+0x54035*4, 0x85f);
DDR_W32(APB_DDRPHY_BASE+0x54036*4, 0x1c);
DDR_W32(APB_DDRPHY_BASE+0x54037*4, 0x1e00);
DDR_W32(APB_DDRPHY_BASE+0x54038*4, 0x2400);
DDR_W32(APB_DDRPHY_BASE+0x54039*4, 0xeb12);
DDR_W32(APB_DDRPHY_BASE+0x5403a*4, 0x2400);
DDR_W32(APB_DDRPHY_BASE+0x5403b*4, 0x85f);
DDR_W32(APB_DDRPHY_BASE+0x5403c*4, 0x1c);
...
DDR_INFO("LPDDR4_DT_1600_TRAIN1D2D_WITH_CA_SETA_DM_DBI: set_msgblock_2d");
DDR_W32(APB_DDRPHY_BASE+0x54000*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54001*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54002*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54003*4, 0x640);
...
DDR_W32(APB_DDRPHY_BASE+0x5400c*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x5400d*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x5400e*4, 0x600);
DDR_W32(APB_DDRPHY_BASE+0x5400f*4, 0x106);
