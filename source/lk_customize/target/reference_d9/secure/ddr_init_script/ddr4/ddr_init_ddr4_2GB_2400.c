//DR_2400_PhyV_0x59_WDBI_0_RDBI_0_DM_1_ODI_0_RTTNOM_0_RTTWR_1_RTTPARK_7_VDQ_0xf_VDQRNG_0x1_VDQCAL_0x1_HDTCTRL_0x4_ODTIMP_40_RK_1_CH_2_RSVD00_0x00_INLINE_ECC_0_SIZE_S1GB
//2021-07-20 20:13:01
DDR_INFO("DR_2400_PhyV_0x59_WDBI_0_RDBI_0_DM_1_ODI_0_RTTNOM_0_RTTWR_1_RTTPARK_7_VDQ_0xf_VDQRNG_0x1_VDQCAL_0x1_HDTCTRL_0x4_ODTIMP_40_RK_1_CH_2_RSVD00_0x00_INLINE_ECC_0_SIZE_S1GB\n");
CFG_DDR_CLK(FREQ_DDR_2400);
//CFG_DDR_CLK(5);
DDR_INFO("ddr4_init start");
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_MP_SBRCTL_OFF, 0x12040);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x9200d3);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x2e0000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc0010126);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0x76000d);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x4606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x8340001);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT4_OFF, 0x180000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT5_OFF, 0x110058);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT6_OFF, 0x2000442);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT7_OFF, 0x800);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RANKCTL_OFF, 0xe225);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x14132814);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x7051b);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x90b050f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0xf00f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x8030409);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x7090404);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG9_OFF, 0x2040c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG10_OFF, 0x100c07);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG11_OFF, 0x1a09010f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG12_OFF, 0xf00000d);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x390820c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG1_OFF, 0x50060202);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0x1511);
...
DDR_INFO("TYPE: DDR4, 2400, train1d2d");
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_PROCODTTIMECTL_P0_OFF, 0x6);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_TXODTDRVSTREN_B0_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_TXODTDRVSTREN_B1_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_TXODTDRVSTREN_B0_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_TXODTDRVSTREN_B1_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_TXODTDRVSTREN_B0_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_TXODTDRVSTREN_B1_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_TXODTDRVSTREN_B0_P0_OFF, 0x38);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_TXODTDRVSTREN_B1_P0_OFF, 0x38);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_CALUCLKINFO_P0_OFF, 0x258);
...
DDR_W32(APB_DDRPHY_BASE+0x5402f*4, 0xa34);
DDR_W32(APB_DDRPHY_BASE+0x54030*4, 0x1);
DDR_W32(APB_DDRPHY_BASE+0x54031*4, 0x818);
DDR_W32(APB_DDRPHY_BASE+0x54032*4, 0x200);
DDR_W32(APB_DDRPHY_BASE+0x54033*4, 0x200);
DDR_W32(APB_DDRPHY_BASE+0x54034*4, 0x500);
DDR_W32(APB_DDRPHY_BASE+0x54035*4, 0x88f);
...
DDR_W32(APB_DDRPHY_BASE+0x541fb*4, 0x34);
DDR_W32(APB_DDRPHY_BASE+0x541fc*4, 0x119);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
...
DDR_INFO("DDR4_DT_2400_TRAIN1D2D: set_msgblock_2d");
DDR_W32(APB_DDRPHY_BASE+0x54000*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54001*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54002*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54003*4, 0x960);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY0_P0_OFF, 0x4b);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY1_P0_OFF, 0x96);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY2_P0_OFF, 0x5dc);
