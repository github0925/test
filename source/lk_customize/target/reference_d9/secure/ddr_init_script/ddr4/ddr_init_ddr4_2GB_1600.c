//DR_1600_PhyV_0x59_WDBI_0_RDBI_0_DM_1_ODI_0_RTTNOM_0_RTTWR_2_RTTPARK_7_VDQ_0xf_VDQRNG_0x1_VDQCAL_0x1_HDTCTRL_0x4_ODTIMP_40_RK_1_CH_2_RSVD00_0x00_INLINE_ECC_0_SIZE_S1GB
//2021-02-27 17:11:21
DDR_INFO("DR_1600_PhyV_0x59_WDBI_0_RDBI_0_DM_1_ODI_0_RTTNOM_0_RTTWR_2_RTTPARK_7_VDQ_0xf_VDQRNG_0x1_VDQCAL_0x1_HDTCTRL_0x4_ODTIMP_40_RK_1_CH_2_RSVD00_0x00_INLINE_ECC_0_SIZE_S1GB\n");
CFG_DDR_CLK(FREQ_DDR_1600);

//cfg_ddr_clk(1600)DDR_INFO("ddr4_init start");
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x61008c);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x2140001);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT4_OFF, 0x100000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT5_OFF, 0x110058);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT6_OFF, 0x2000441);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT7_OFF, 0x400);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RANKCTL_OFF, 0xe225);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x100e1a0e);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x50514);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x808040d);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0xe00e);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x6030306);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x4060302);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG9_OFF, 0x2030b);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG10_OFF, 0x100c07);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG11_OFF, 0x1a06010f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG12_OFF, 0xe000008);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x38b820a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG1_OFF, 0x30060202);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0xe0d);
...
DDR_INFO("TYPE: DDR4, 1600, train1d2d");
...
DDR_INFO("DDR4_DT_1600_TRAIN1D2D: set_msgblock");
...
DDR_W32(APB_DDRPHY_BASE+0x541fb*4, 0x14);
DDR_W32(APB_DDRPHY_BASE+0x541fc*4, 0x111);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
...
DDR_INFO("DDR4_DT_1600_TRAIN1D2D: set_msgblock_2d");
DDR_W32(APB_DDRPHY_BASE+0x54000*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54001*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54002*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54003*4, 0x640);
