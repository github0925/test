//DR_800_PhyV_0x62_DM_1_ODI_0_RTTNOM_0_RTTWR_1_HDTCTRL_0x4_ODTIMP_60_RK_1_CH_2_RSVD00_0x00_TRAINTYPE_1_SIZE_S1GB
//2021-12-21 09:38:05
DDR_INFO("DR_800_PhyV_0x62_DM_1_ODI_0_RTTNOM_0_RTTWR_1_HDTCTRL_0x4_ODTIMP_60_RK_1_CH_2_RSVD00_0x00_TRAINTYPE_1_SIZE_S1GB\n");
CFG_DDR_CLK(FREQ_DDR_800);
DDR_INFO("ddr3_init start");
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x19d8006e);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x2e0000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc0010062);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0x28000d);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x4606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x4200001);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT4_OFF, 0x0);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x60a0608);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x5020b);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x3030205);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0x6006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x3020204);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x3030202);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG6_OFF, 0xe000d);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG7_OFF, 0x303);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ODTCFG_OFF, 0xf04090c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x5818200);
...
DDR_INFO("TYPE: DDR3, 800, train1d");
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_VREFINGLOBAL_P0_OFF, 0x2a0);
...
DDR_INFO("DDR3_DT_800_TRAIN1D: set_msgblock");
...
DDR_W32(APB_DDRPHY_BASE+0x54006*4, 0x162);
...
DDR_W32(APB_DDRPHY_BASE+0x5402f*4, 0x320);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY1_P0_OFF, 0x27);
