/*
* mipi_hsd123_serdes_1920x720_v9ts_lcd.c
*
...
static void dsi_pwn_n_port_config(void)
{
    ...
    hal_dio_write_channel(dio_handle, PortConf_PIN_I2S_MC_SCK, 1);
...
struct sdm_panel mipi_hsd123_serdes_1920x720_v9ts_lcd = {
    .panel_name = "mipi_hsd123_serdes_1920x720_v9ts_lcd",
    .if_type = IF_TYPE_DSI,
