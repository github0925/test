...
typedef struct {
    volatile uint32_t fuse_ctrl;  /* offset: 0x0 */
    volatile uint32_t prog_data;  /* offset: 0x4 */
    volatile uint32_t fuse_trig;  /* offset: 0x8 */
    volatile uint32_t read_fuse_data;  /* offset: 0xc */
    volatile uint32_t fuse_timing_0;  /* offset: 0x10 */
    volatile uint32_t fuse_timing_1;  /* offset: 0x14 */
    volatile uint32_t check_fuse_addr;  /* offset: 0x18 */
    volatile uint32_t sema_lock;  /* offset: 0x1c */
    volatile uint32_t int_sta;  /* offset: 0x20 */
    volatile uint32_t int_sta_en;  /* offset: 0x24 */
    volatile uint32_t int_sig_en;  /* offset: 0x28 */
    uint8_t rsvd0[212];
    volatile uint32_t ecc_sig_error0;  /* offset: 0x100 */
    volatile uint32_t ecc_sig_error1;  /* offset: 0x104 */
    volatile uint32_t ecc_sig_error2;  /* offset: 0x108 */
    volatile uint32_t ecc_sig_error3;  /* offset: 0x10c */
    volatile uint32_t ecc_sig_error4;  /* offset: 0x110 */
    volatile uint32_t ecc_mul_error0;  /* offset: 0x114 */
    volatile uint32_t ecc_mul_error1;  /* offset: 0x118 */
    volatile uint32_t ecc_mul_error2;  /* offset: 0x11c */
    volatile uint32_t ecc_mul_error3;  /* offset: 0x120 */
    volatile uint32_t ecc_mul_error4;  /* offset: 0x124 */
    volatile uint32_t red_error0;  /* offset: 0x128 */
    volatile uint32_t lock_red_error;  /* offset: 0x12c */
    uint8_t rsvd1[208];
    volatile uint32_t ecc_data_corr_0;  /* offset: 0x200 */
    volatile uint32_t ecc_corr_0;  /* offset: 0x204 */
    volatile uint32_t ecc_data_corr_1;  /* offset: 0x208 */
    volatile uint32_t ecc_corr_1;  /* offset: 0x20c */
    volatile uint32_t ecc_data_corr_2;  /* offset: 0x210 */
    volatile uint32_t ecc_corr_2;  /* offset: 0x214 */
    volatile uint32_t ecc_data_corr_3;  /* offset: 0x218 */
    volatile uint32_t ecc_corr_3;  /* offset: 0x21c */
    volatile uint32_t red_data_corr;  /* offset: 0x220 */
    volatile uint32_t red_corr;  /* offset: 0x224 */
    uint8_t rsvd2[216];
    volatile uint32_t se_glb_lock;  /* offset: 0x300 */
    volatile uint32_t se_bank_lock0;  /* offset: 0x304 */
    volatile uint32_t se_bank_lock1;  /* offset: 0x308 */
    volatile uint32_t se_bank_lock2;  /* offset: 0x30c */
    volatile uint32_t se_bank_lock3;  /* offset: 0x310 */
    volatile uint32_t ap_glb_lock;  /* offset: 0x314 */
    volatile uint32_t ap_bank_lock0;  /* offset: 0x318 */
    volatile uint32_t ap_bank_lock1;  /* offset: 0x31c */
    volatile uint32_t ap_bank_lock2;  /* offset: 0x320 */
    volatile uint32_t ap_bank_lock3;  /* offset: 0x324 */
    uint8_t rsvd3[216];
    volatile uint32_t data_inj;  /* offset: 0x400 */
    volatile uint32_t ecc_inj;  /* offset: 0x404 */
    uint8_t rsvd4[248];
    volatile uint32_t sw_sticky_se0;  /* offset: 0x500 */
    volatile uint32_t sw_sticky_se1;  /* offset: 0x504 */
    volatile uint32_t sw_sticky_se2;  /* offset: 0x508 */
    volatile uint32_t sw_sticky_se3;  /* offset: 0x50c */
    volatile uint32_t sw_sticky_ap0;  /* offset: 0x510 */
    volatile uint32_t sw_sticky_ap1;  /* offset: 0x514 */
    volatile uint32_t sw_sticky_ap2;  /* offset: 0x518 */
    volatile uint32_t sw_sticky_ap3;  /* offset: 0x51c */
    uint8_t rsvd5[2784];
    volatile uint32_t lock_fuse[8];  /* offset: 0x1000 */
    volatile uint32_t fuse_word[248];  /* offset: 0x1020 */
} fuse_ctrl_t;
