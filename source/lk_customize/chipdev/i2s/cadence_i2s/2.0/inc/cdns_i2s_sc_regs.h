...
typedef union {
    struct {
        ...
        // non-tdm mode:bit 8:0--dsp;1--standard audio i/f spec format. tdm mode: 0-dsp,other-ws changes after given nunber of channels.
        volatile u32 ws_mode: 4;
        // 1-right audio channel 0-left audio chan is active
        volatile u32 mono_mode: 1;
        // (non-tdm&&stand i/f)1--mono mode is active 0--both left & right.
