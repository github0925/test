...
/* Because dmac1 channel 8 need configure scr and can't work with other channel together, disable it. */
#define DW_DMAC1_CHANNEL_NUMB (7)

#define DW_DMAC1_MAX_NUMB (1)

#define DW_DMAC1_MAX_BLK_SIZE (0x10000) /* 0x200000 Semidrive change to 0x10000 (the register is 0xFFFF) */
#define DW_DMAC1_LLI_LAST_OFFSET (0x4000000000000000)
typedef enum
{
    DMA1_TRANSFER_TYPE_CONTINUOUS = 0, /* both src and dst set continuous result single type */
    DMA1_TRANSFER_TYPE_RELOAD,
    DMA1_TRANSFER_TYPE_SHADOW,
    DMA1_TRANSFER_TYPE_LLI,
} DMA1_TRANSFER_TYPE;

typedef enum
{
    DMA1_TRANSFER_ADDR_INCREMENT = 0, /* both src and dst set continuous result single type */
    DMA1_TRANSFER_ADDR_NOCHANGE = 1,
} DMA1_TRANSFER_ADDRESS;

typedef enum
{
    DMA1_TRANSFER_DIR_MEM2MEM_DMAC = 0,
    DMA1_TRANSFER_DIR_MEM2PER_DMAC = 1,
    DMA1_TRANSFER_DIR_PER2MEM_DMAC = 2,
    DMA1_TRANSFER_DIR_PER2PER_DMAC = 3,
    DMA1_TRANSFER_DIR_PER2MEM_SRC = 4,
    DMA1_TRANSFER_DIR_PER2PER_SRC = 5,
    DMA1_TRANSFER_DIR_MEM2PER_DST = 6,
    DMA1_TRANSFER_DIR_PER2PER_DST = 7,
} DMA1_TRANSFER_DIRECTION;

typedef enum
{
    DMA1_TRANSFER_WIDTH_8BITS = 0,   /* 1 */
    DMA1_TRANSFER_WIDTH_16BITS = 1,  /* 2 */
    DMA1_TRANSFER_WIDTH_32BITS = 2,  /* 4 */
    DMA1_TRANSFER_WIDTH_64BITS = 3,  /* 8 */
    DMA1_TRANSFER_WIDTH_128BITS = 4, /* 16 */
    DMA1_TRANSFER_WIDTH_256BITS = 5, /* 32 */
    DMA1_TRANSFER_WIDTH_512BITS = 6, /* 64 */
    DMA1_TRANSFER_WIDTH_MAX = DMA1_TRANSFER_WIDTH_512BITS
} DMA1_TRANSFER_WIDTH;
...
typedef enum
{
    DMA1_BLOCK_TR_DONE = BIT(0xffffffff, 0),
    DMA1_DMA_TR_DONE = BIT(0xffffffff, 1),
    DMA1_SRC_COMP = BIT(0xffffffff, 3),
    DMA1_DST_COMP = BIT(0xffffffff, 4),
    DMA1_SRC_DEC_ERR = BIT(0xffffffff, 5),
    DMA1_DST_DEC_ERR = BIT(0xffffffff, 6),
    DMA1_SRC_SLV_ERR = BIT(0xffffffff, 7),
    DMA1_DST_SLV_ERR = BIT(0xffffffff, 8),
    DMA1_LLI_RD_DEC_ERR = BIT(0xffffffff, 9),
    DMA1_LLI_WR_DEC_ERR = BIT(0xffffffff, 10),
    DMA1_LLI_RD_SLV_ERR = BIT(0xffffffff, 11),
    DMA1_LLI_WR_SLV_ERR = BIT(0xffffffff, 12),
    DMA1_INVALID_ERR = BIT(0xffffffff, 13),
    DMA1_MULTIBLKTYPE_ERR = BIT(0xffffffff, 14),
    DMA1_DEC_ERR = BIT(0xffffffff, 16),
    DMA1_WR2RO_ERR = BIT(0xffffffff, 17),
    DMA1_RD2RWO_ERR = BIT(0xffffffff, 18),
    DMA1_WR_ON_CHEN_ERR = BIT(0xffffffff, 19),
    DMA1_SHADOW_WR_VALID_ERR = BIT(0xffffffff, 20),
    DMA1_WR_ONHOLD_ERR = BIT(0xffffffff, 21),
    DMA1_LOCK_CLEARED = BIT(0xffffffff, 27),
    DMA1_SRC_SUSPENDED = BIT(0xffffffff, 28),
    DMA1_SUSPENDED = BIT(0xffffffff, 29),
    DMA1_DISABLED = BIT(0xffffffff, 30),
    DMA1_ABORTED = BIT(0xffffffff, 31),
    DMA1_ALL_ERR = (GEN_MASK(21, 16) | GEN_MASK(14, 5)),
    DMA1_ALL = GEN_MASK(31, 0)
} DMA1_INT_STATUS;
/*    */
...
typedef union {
    struct
    {
        ...
        volatile u32 padding_1 : 32;
        volatile u32 rsvd1 : 32;
        volatile u32 padding_2 : 32;
    };
    struct
    {
        volatile u32 vl;
        volatile u32 padding_3;
        volatile u32 vh;
        volatile u32 padding_4;
    };
} dmac1_cfg_t;
...
typedef union {
    struct
    {
        ...
        volatile u32 comm_reg_int_Stat : 1; /* CCommon Register Interrupt Status Bit. */
...
typedef union {
    struct
    {
        volatile u32 lms : 1; /* DMAX_CH(x)_LMS == 2) ? "read-write" : "read-only"} */
        volatile u32 rsvd : 5;
        volatile u32 loc_l : 26;
        volatile u32 padding_1 : 32;
        volatile u32 loc_h : 32; /*  **********Starting Address Memory of LLI block */
        volatile u32 padding_2 : 32;
    };
    struct
    {
...
typedef union {
    ...
    {
        volatile u32 vl;
        volatile u32 padding_3 : 32;
        volatile u32 vh;
        volatile u32 padding_4 : 32;
    };
} ch_int_sig_en_t;
...
/* dmac channel */
typedef struct dmac1_ch
{
    volatile u32 sar_l; /*  Source Address Register      0x100 + x(x-1)*0x100 */
    volatile u32 padding_1;
    volatile u32 sar_h;
    volatile u32 padding_2;
    volatile u32 dar_l; /* Destination Address Register 0x108 + x(x-1)*0x100 */
    volatile u32 padding_3;
    volatile u32 dar_h;
    volatile u32 padding_4;
    volatile dmac1_ch_blk_ts_t blk_ts; /*  block-size. 0x110 + x(x-1)*0x100 */
    volatile dmac1_ch_ctl_t ctl;       /*  Control Register   0x118 + x(x-1)*0x100 */
    volatile dmac1_ch_cfg_t cfg;       /*  Configuration Register */
    volatile dmac1_ch_llp_t llp;       /*  Linked List Pointer register. */
    volatile dmac1_ch_stat_t status;   /*  Channelx Status Register 0x130 */
    volatile u32 swhssrc_l;            /* *********** Channelx Software handshake Source Register. */
    volatile u32 padding_5;
    volatile u32 swhssrc_h; /*  Channelx Software handshake Source Register. */
    volatile u32 padding_6;
    volatile u32 swhsdst_l; /* ************* Channelx Software handshake Destination Register. */
    volatile u32 padding_7;
    volatile u32 swhsdst_h; /*  Channelx Software handshake Destination Register. */
    volatile u32 padding_8;
    volatile u32 blk_tr_resume_req_l; /* ************Channelx Block Transfer Resume Request Register. */
    volatile u32 padding_9;
    volatile u32 blk_tr_resume_req_h; /* Channelx Block Transfer Resume Request Register. */
    volatile u32 padding_10;
    volatile u32 axi_id_l; /* ******Channelx AXI ID Register. */
    volatile u32 padding_11;
    volatile u32 axi_id_h; /* Channelx AXI ID Register. */
    volatile u32 padding_12;
    volatile u32 axi_qos_l; /* ********Channelx AXI QOS Register. */
    volatile u32 padding_13;
    volatile u32 axi_qos_h; /* Channelx AXI QOS Register. */
    volatile u32 padding_14;
    volatile u32 sstat_l; /* ************* */
    volatile u32 padding_15;
    volatile u32 sstat_h;
    volatile u32 padding_16;
    volatile u32 dstat_l; /* ************* */
    volatile u32 padding_17;
    volatile u32 dstat_h;
    volatile u32 padding_18;
    volatile u32 sstatar_l; /* *********Channelx Source Status Fetch Register. */
    volatile u32 padding_19;
    volatile u32 sstatar_h; /* Channelx Source Status Fetch Register. */
    volatile u32 padding_20;
    volatile u32 dstatar_l; /* ************Channelx Destination Status Fetch Register. */
    volatile u32 padding_21;
    volatile u32 dstatar_h; /* Channelx Destination Status Fetch Register. */
    volatile u32 padding_22;
    volatile dmac1_ch_int_stat_en_t int_stat_en; /* CHx_INTSTATUS_ENABLEREG */
    volatile dmac1_ch_int_stat_t int_stat;       /* Channelx Interrupt Status Register captures the Channelx specific interrupts */
    volatile ch_int_sig_en_t int_sig_en;         /* This register contains fields that are used to enable the generation of port level interrupt at the channel level. */
    volatile dmac1_ch_int_clr_t int_clr;         /* Writing 1 to specific field will clear the corresponding field in Channelx Interrupt Status Register */
    volatile u64 rsvd[12 * 2];
...
typedef struct
{
    volatile u32 dmac_id_l; /* 0x0 */
    volatile u32 padding_1;
    volatile u32 dmac_id_h;
    volatile u32 padding_2;
    ...
    volatile dmac1_cfg_t dmac_cfg;     /* 0x10	 */
    volatile dmac1_ch_en_t dmac_ch_en; /* 0x18	 */

    volatile u32 dmac_ch_susp_l; /* 0x20 This is DW_axi_dmac Channel Suspend Register. */
    volatile u32 padding_5;
    volatile u32 dmac_ch_susp_h;
    volatile u32 padding_6;

    volatile u32 dmac_ch_abort_l; /*  0x28 Channel Abort Register. */
    volatile u32 padding_7;
    volatile u32 dmac_ch_abort_h;
    volatile u32 padding_8;

    volatile dmac1_int_stat_t dmac_int_stat;                 /* 0x30 DMAC Interrupt Status Register */
    volatile dmac1_comm_int_clr_t dmac_comm_int_clr;         /* 0x38 DMAC_COMMONREG_INTCLEARREG	 */
    volatile dmac1_comm_int_stat_en_t dmac_comm_int_stat_en; /* 0x40 DMAC_COMMONREG_INTSTATUS_ENABLEREG */
    volatile dmac1_comm_int_sig_en_t dmac_comm_int_sig_en;   /* 0x48 MAC_COMMONREG_INTSIGNAL_ENABLEREG	 */
    volatile dmac1_comm_int_stat_t dmac_comm_int_stat;       /* 0x50 DMAC_COMMONREG_INTSTATUSREG	 */
    volatile dmac1_reset_t dmac_reset;                       /* 0x58 DMAC_RESETREG			 */

    volatile u32 dmac_low_pm_cfg_l; /*  0x60 DMAC_LOWPOWER_CFGREG	 */
    volatile u32 padding_9;
    volatile u32 dmac_low_pm_cfg_h;
    volatile u32 padding_10;

    volatile u64 rsvd_2[19 * 2]; /* 0x68	 */

    volatile dmac1_ch_t ch[DW_DMAC1_CHANNEL_NUMB];
} dw_dmac1_t;
/**
 * @description:
 * Dmac int handle structure call back function for irq.
 */
typedef struct dmac1_irq_cbk
{
...
typedef struct dmac1_coeff
{
    ...
    /* u64 ll_call_back;    */    /* lined list call back function pointer */
    dmac1_irq_cbk_t irq_callback; /* dmac irq call back function. */
} dmac1_coeff_t;
/* init and set dmac base address. */
void dw_init_dmac1(int instance, void *dmac_base, void *dma_mux_addr);
/* config dmac */
...
addr_t dw_dmac1_peri_addr_convert(addr_t addr);
/* dmac channel configure. */
bool dw_dmac1_ch_reg_cfg(dmac1_coeff_t cfg);
/* dmac config mux */
...
/* bool dw_dmac_mux_cfg(dmac1_coeff_t cfg); */
/* enable irq */
