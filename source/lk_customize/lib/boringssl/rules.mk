...
LOCAL_SRC_FILES := $(filter-out src/crypto/asn1/a_gentm.c,$(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out src/crypto/evp/p_ec.c,$(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out src/third_party/fiat/curve25519.c,$(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out src/crypto/evp/p_ed25519_asn1.c,$(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out src/crypto/fipsmodule/rand/urandom.c,$(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out src/crypto/fipsmodule/bcm.c,$(LOCAL_SRC_FILES))
