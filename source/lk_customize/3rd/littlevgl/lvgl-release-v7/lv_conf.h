...
#define LV_USE_GPU_SEMIDRIVE_G2D  1
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE    "platform.h"      /*Header for the system time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (current_time())     /*Expression evaluating to current system time in ms*/
