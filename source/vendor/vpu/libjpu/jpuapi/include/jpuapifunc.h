...
/*
the length of jpu read at a time,
When a new frame starts in the last 1024 bytes of the bs buffer,
but there is no SOS field, jpu will decode errors,
so, wraparound_bistream_data func will copy the remaining buffer to the head of the bs buffer
*/
