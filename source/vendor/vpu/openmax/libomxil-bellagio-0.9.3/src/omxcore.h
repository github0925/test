...
#define SPECVERSIONMAJOR  OMX_VERSION_MAJOR
/** Defines the minor version of the core */
#ifdef ANDROID
#define SPECVERSIONMINOR  OMX_VERSION_MINOR		// still don't know that what version will use in android.
#else
#define SPECVERSIONMINOR  OMX_VERSION_MINOR
#endif
/** Defines the revision of the core */
#define SPECREVISION      OMX_VERSION_REVISION
/** Defines the step version of the core */
#define SPECSTEP          OMX_VERSION_STEP
#else
/** Defines the major version of the core */
