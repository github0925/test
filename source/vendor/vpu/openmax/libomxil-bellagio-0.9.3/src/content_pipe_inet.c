...
*/
static CPresult Open( CPhandle* hContent, CPstring szURI, CP_ACCESSTYPE eAccess __attribute__((unused)))
{
  inet_ContentPipe* pPipe = (inet_ContentPipe*) hContent;
  CPresult err = 0;
#if defined(WIN32)
...
static CPresult CheckAvailableBytes( CPhandle hContent __attribute__((unused)), CPuint nBytesRequested __attribute__((unused)),
  CP_CHECKBYTESRESULTTYPE *eResult __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult SetPosition( CPhandle  hContent __attribute__((unused)), CPint nOffset __attribute__((unused)), CP_ORIGINTYPE eOrigin __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult GetPosition( CPhandle hContent __attribute__((unused)), CPuint *pPosition __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult ReadBuffer( CPhandle hContent __attribute__((unused)), CPbyte **ppBuffer __attribute__((unused)),
  CPuint *nSize __attribute__((unused)), CPbool bForbidCopy __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult ReleaseReadBuffer(CPhandle hContent __attribute__((unused)), CPbyte *pBuffer __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult GetWriteBuffer( CPhandle hContent __attribute__((unused)), CPbyte **ppBuffer __attribute__((unused)), CPuint nSize __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult WriteBuffer( CPhandle hContent __attribute__((unused)), CPbyte *pBuffer __attribute__((unused)), CPuint nFilledSize __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
static CPresult RegisterCallback( CPhandle hContent __attribute__((unused)), CPresult (*ClientCallback)(CP_EVENTTYPE eEvent, CPuint iParam) __attribute__((unused)))
{
  DEBUG(DEB_LEV_FUNCTION_NAME, "content_pipe_inet:%s \n", __func__);
...
CPresult inet_pipe_Constructor(CP_PIPETYPE **ppPipe, CPstring szURI __attribute__((unused)))
{
