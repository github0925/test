...
#ifndef SEMI_OMX_PLUGIN_H_

#define SEMI_OMX_PLUGIN_H_

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct SemiOMXPlugin : public OMXPluginBase {
    SemiOMXPlugin();
    virtual ~SemiOMXPlugin();
...
private:
    ...
    SemiOMXPlugin(const SemiOMXPlugin &);
    SemiOMXPlugin &operator=(const SemiOMXPlugin &);
};

}  // namespace android

#endif  // SEMI_OMX_PLUGIN_H_
