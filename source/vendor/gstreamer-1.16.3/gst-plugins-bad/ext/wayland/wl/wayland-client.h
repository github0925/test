...
int connect_to_vsync_socket(const char *name);
...
int32_t wl_display_get_conn_err();
...
int wl_display_dispatch_one(struct wl_display *display);
int wl_display_dispatch_pending_one(struct wl_display *display);
int wl_display_roundtrip_one(struct wl_display *display);
