...
gboolean gst_omx_buffer_bo_alloc (GstBufferPool * object, GstVideoInfo * vinfo, guint * prime_fd);

gboolean gst_omx_buffer_bo_free (GstBufferPool * object, guint prime_fd);
