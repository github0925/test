...
typedef struct dm_drm_drv_t
{
  ...
  int (*map) (struct dm_drm_t *drv, struct dm_drm_bo_t *bo, int x, int y,
              int w, int h, void **addr);
...
struct dm_drm_bo_t *dm_drm_bo_create (struct dm_drm_t *drm, int width,
                                      int height, int format, int usage);
int dm_drm_bo_lock (struct dm_drm_bo_t *bo, int usage, int x, int y, int w,
                    int h, void **addr);
void dm_drm_bo_unlock (struct dm_drm_bo_t *bo);
struct dm_drm_bo_t *dm_drm_bo_create_from_fd (struct dm_drm_t *drm,
                                              struct dm_meta_data *data);
/**********************************************************/
