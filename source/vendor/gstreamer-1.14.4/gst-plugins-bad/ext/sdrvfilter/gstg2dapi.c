...
g2d_get_pitch (int format, int width)
{
  ...
  GST_DEBUG_OBJECT (gG2dContext->object, "format %d, width: %d , pitch width: %d ",format, width, pitch);
  return pitch;
}
...
g2d_convert_format (int format)
{
  ...
  switch (format) {
    case GST_VIDEO_FORMAT_RGBx:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format :DRM_FORMAT_XBGR8888");
      outFormat = DRM_FORMAT_XBGR8888;
      break;
    case GST_VIDEO_FORMAT_xRGB:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format :DRM_FORMAT_BGRX8888");
      outFormat = DRM_FORMAT_BGRX8888;
      break;
    case GST_VIDEO_FORMAT_BGRx:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat:DRM_FORMAT_XRGB8888");
      outFormat = DRM_FORMAT_XRGB8888;
      break;
    ...
    case GST_VIDEO_FORMAT_BGRA:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat:DRM_FORMAT_ARGB8888");
      outFormat = DRM_FORMAT_ARGB8888;
      break;
    case GST_VIDEO_FORMAT_RGBA:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat :DRM_FORMAT_ABGR8888");
      outFormat = DRM_FORMAT_ABGR8888;
      break;
    ...
    case GST_VIDEO_FORMAT_UYVY:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat:DRM_FORMAT_UYVY");
      outFormat = DRM_FORMAT_UYVY;
      break;
    case GST_VIDEO_FORMAT_VYUY:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat:DRM_FORMAT_VYUY");
      outFormat = DRM_FORMAT_VYUY;
      break;
    case GST_VIDEO_FORMAT_BGR:
      GST_DEBUG_OBJECT (gG2dContext->object,
          "g2d_convert_format outFormat:DRM_FORMAT_RGB888");
      outFormat = DRM_FORMAT_RGB888;
      break;
  ...
  switch(input->output.nplanes)
  {
    case 3:
      if ((input->output.fmt == DRM_FORMAT_YUV420) || (input->output.fmt == DRM_FORMAT_YVU420)) {
        ...
        GST_ERROR_OBJECT (gG2dContext->object, "output nplanes 3 ,set stride do not support format : %x", input->output.fmt);
        return -1;
      }
      break;
    case 2:
    ...
    case 1:
      ...
      break;
    default:
      GST_ERROR_OBJECT (gG2dContext->object, "input->output:%d is error value",input->output.nplanes);
      break;
  }
