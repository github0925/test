//DT_800_PS_1_PhyV_0xf_DBI_1_DM_1_PDDS_6_DQODT_5_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x1f_VDQ_0x12_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_2_CH_2_PUCAL_1_RSVD00_0x0_ECC_0_TRAINTYPE_12_SIZE_S8GB
//2021-05-17 18:58:39
DDR_INFO("DT_800_PS_1_PhyV_0xf_DBI_1_DM_1_PDDS_6_DQODT_5_SOCODT_6_ODTIMP_40_TXIMP_40_ATXIMP_40_CAODT_0x2_VCA_0x1f_VDQ_0x12_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_2_CH_2_PUCAL_1_RSVD00_0x0_ECC_0_TRAINTYPE_12_SIZE_S8GB\n");
DDR_INFO("lpddr4 init start...");
CFG_DDR_CLK(FREQ_DDR_800)
//DDR_R32(0xf3020080);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DERATEEN_OFF, 0x1011);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHCTL1_OFF, 0x14000a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHCTL3_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x18004c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x120000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc0010188);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0x28000a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x8d05);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x140009);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT4_OFF, 0xf10008);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0xc080d09);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x3040c);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x3060c0d);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0x505006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0x4040204);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x2030303);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG6_OFF, 0x20b0004);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL0_OFF, 0x50c80006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL1_OFF, 0xa00070);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL2_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ODTCFG_OFF, 0x6070e74);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x4878202);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0x702);
...
DDR_INFO("TYPE: lpddr4 800, train1d2d with ca, seta, dm, dbi");
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_PLLCTRL2_P0_OFF, 0x7);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_CALUCLKINFO_P0_OFF, 0xc8);
...
DDR_W32(APB_DDRPHY_BASE+0x54019*4, 0x914);
DDR_W32(APB_DDRPHY_BASE+0x5401a*4, 0xf3);
DDR_W32(APB_DDRPHY_BASE+0x5401b*4, 0x5f25);
DDR_W32(APB_DDRPHY_BASE+0x5401c*4, 0x1208);
DDR_W32(APB_DDRPHY_BASE+0x5401d*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x5401e*4, 0x1e);
DDR_W32(APB_DDRPHY_BASE+0x5401f*4, 0x914);
DDR_W32(APB_DDRPHY_BASE+0x54020*4, 0xf3);
DDR_W32(APB_DDRPHY_BASE+0x54021*4, 0x5f25);
DDR_W32(APB_DDRPHY_BASE+0x54022*4, 0x1208);
...
DDR_W32(APB_DDRPHY_BASE+0x54032*4, 0x1400);
DDR_W32(APB_DDRPHY_BASE+0x54033*4, 0xf309);
DDR_W32(APB_DDRPHY_BASE+0x54034*4, 0x2500);
DDR_W32(APB_DDRPHY_BASE+0x54035*4, 0x85f);
DDR_W32(APB_DDRPHY_BASE+0x54036*4, 0x12);
DDR_W32(APB_DDRPHY_BASE+0x54037*4, 0x1e00);
DDR_W32(APB_DDRPHY_BASE+0x54038*4, 0x1400);
DDR_W32(APB_DDRPHY_BASE+0x54039*4, 0xf309);
DDR_W32(APB_DDRPHY_BASE+0x5403a*4, 0x2500);
DDR_W32(APB_DDRPHY_BASE+0x5403b*4, 0x85f);
DDR_W32(APB_DDRPHY_BASE+0x5403c*4, 0x12);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x0);
LOAD_DDR_TRAINING_FW(ICCM, DDRPHY_FW_LPDDR4_2D);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x0);
LOAD_DDR_TRAINING_FW(DCCM, DDRPHY_FW_LPDDR4_2D);
DDR_INFO("LPDDR4_DT_800_TRAIN1D2D_WITH_CA_SETA_DM_DBI: set_msgblock_2d");
DDR_W32(APB_DDRPHY_BASE+0x54000*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54001*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54002*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x54003*4, 0x320);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICRORESET_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICRORESET_OFF, 0x0);
DDRPHY_WAITFWDONE(DDRPHY_FW_LPDDR4_2D);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICRORESET_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x0);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x0);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_DBYTEDLLMODECNTRL_OFF, 0x2);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY0_P0_OFF, 0x19);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY1_P0_OFF, 0x32);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY2_P0_OFF, 0x1f4);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY3_P0_OFF, 0x10);
