//2133_PS_1_PhyV_0x14_DBI_0_DM_1_PDDS_6_DQODT_5_SOCODT_6_ODTIMP_40_CAODT_0x2_VCA_0x26_VCARNG_0x0_VDQ_0x41_VDQRNG_0x0_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_1_CH_1_PUCAL_1_RSVD00_0x0_ECC_0_G9_TRAINTYPE_1
//2020-09-03 13:49:22
DDR_INFO("2133_PS_1_PhyV_0x14_DBI_0_DM_1_PDDS_6_DQODT_5_SOCODT_6_ODTIMP_40_CAODT_0x2_VCA_0x26_VCARNG_0x0_VDQ_0x41_VDQRNG_0x0_CKODTEN_0x1_CSODTEN_0x1_CAODTDIS_0_HDTCTRL_0x04_POSTAMBLE_1_RK_1_CH_1_PUCAL_1_RSVD00_0x0_ECC_0_G9_TRAINTYPE_1\n");
CFG_DDR_CLK(FREQ_DDR_2133);
//DDR_SEQ_VERSION_PRINT(0x00010002);         //initial version: v1.0.1
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP1_OFF, 0x70707);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP2_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP3_OFF, 0x1f000000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP4_OFF, 0x1f1f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP5_OFF, 0x60f0606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP6_OFF, 0x6060606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP7_OFF, 0xf0f);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP8_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP9_OFF, 0x6060606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP10_OFF, 0x6060606);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ADDRMAP11_OFF, 0x6);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_MSTR_OFF, 0x81081020);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DERATEEN_OFF, 0x1111);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG_OFF, 0x200096);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_RFSHTMG1_OFF, 0x300000);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT0_OFF, 0xc0020413);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT1_OFF, 0x69000a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT2_OFF, 0x8d05);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT3_OFF, 0x34001b);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_INIT4_OFF, 0x310008);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG0_OFF, 0x14162417);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG1_OFF, 0x40420);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG2_OFF, 0x50a1112);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG3_OFF, 0x708006);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG4_OFF, 0xa04060a);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG5_OFF, 0x2030808);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG6_OFF, 0x20b0005);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG7_OFF, 0x302);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG13_OFF, 0xa100002);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG14_OFF, 0x4e1);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DRAMTMG15_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL0_OFF, 0x52160010);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL1_OFF, 0x1b00070);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ZQCTL2_OFF, 0x0);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_ODTCFG_OFF, 0x6070e74);
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG0_OFF, 0x48f8206);
...
DDR_W32(APB_DDRCTRL_BASE+UMCTL2_REGS_DFITMG2_OFF, 0xf06);
...
DDR_INFO("TYPE: lpddr4 2133, train1d with ca, seta, dm, nodbi, 16bit mode");
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_TXSLEWRATE_B0_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_TXSLEWRATE_B1_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_TXSLEWRATE_B0_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_TXSLEWRATE_B1_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_TXSLEWRATE_B0_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_TXSLEWRATE_B1_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_TXSLEWRATE_B0_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_TXSLEWRATE_B1_P0_OFF, 0x17f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ0LNSEL_OFF, 0x3);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ1LNSEL_OFF, 0x7);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ2LNSEL_OFF, 0x2);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ3LNSEL_OFF, 0x0);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ4LNSEL_OFF, 0x5);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ5LNSEL_OFF, 0x4);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ6LNSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE0_DQ7LNSEL_OFF, 0x6);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ0LNSEL_OFF, 0x7);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ1LNSEL_OFF, 0x5);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ2LNSEL_OFF, 0x4);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ3LNSEL_OFF, 0x2);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ4LNSEL_OFF, 0x3);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ5LNSEL_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ6LNSEL_OFF, 0x0);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE1_DQ7LNSEL_OFF, 0x6);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB0_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB1_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB2_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB3_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB4_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB5_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB6_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB7_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB8_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_ANIB9_ATXSLEWRATE_OFF, 0x15f);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_PLLCTRL2_P0_OFF, 0xa);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_DFIMODE_OFF, 0x1);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_CALUCLKINFO_P0_OFF, 0x215);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_CALRATE_OFF, 0x9);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_VREFINGLOBAL_P0_OFF, 0x104);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_DBYTEMISCMODE_OFF, 0x4);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE2_DQDQSRCVCNTRL1_OFF, 0x7ff);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_DBYTEMISCMODE_OFF, 0x4);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_DBYTE3_DQDQSRCVCNTRL1_OFF, 0x7ff);
...
DDR_W32(APB_DDRPHY_BASE+0x54012*4, 0x110);
...
DDR_W32(APB_DDRPHY_BASE+0x54019*4, 0x1b34);
DDR_W32(APB_DDRPHY_BASE+0x5401a*4, 0x33);
DDR_W32(APB_DDRPHY_BASE+0x5401b*4, 0x2625);
DDR_W32(APB_DDRPHY_BASE+0x5401c*4, 0x4108);
DDR_W32(APB_DDRPHY_BASE+0x5401d*4, 0x0);
DDR_W32(APB_DDRPHY_BASE+0x5401e*4, 0x1e);
DDR_W32(APB_DDRPHY_BASE+0x5401f*4, 0x1b34);
DDR_W32(APB_DDRPHY_BASE+0x54020*4, 0x33);
DDR_W32(APB_DDRPHY_BASE+0x54021*4, 0x2625);
DDR_W32(APB_DDRPHY_BASE+0x54022*4, 0x4108);
...
DDR_W32(APB_DDRPHY_BASE+0x5402c*4, 0x1);
...
DDR_W32(APB_DDRPHY_BASE+0x54032*4, 0x3400);
DDR_W32(APB_DDRPHY_BASE+0x54033*4, 0x331b);
DDR_W32(APB_DDRPHY_BASE+0x54034*4, 0x2500);
DDR_W32(APB_DDRPHY_BASE+0x54035*4, 0x826);
DDR_W32(APB_DDRPHY_BASE+0x54036*4, 0x41);
DDR_W32(APB_DDRPHY_BASE+0x54037*4, 0x1e00);
DDR_W32(APB_DDRPHY_BASE+0x54038*4, 0x3400);
DDR_W32(APB_DDRPHY_BASE+0x54039*4, 0x331b);
DDR_W32(APB_DDRPHY_BASE+0x5403a*4, 0x2500);
DDR_W32(APB_DDRPHY_BASE+0x5403b*4, 0x826);
DDR_W32(APB_DDRPHY_BASE+0x5403c*4, 0x41);
...
DDRPHY_WAITFWDONE(DDRPHY_FW_LPDDR4_1D);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICRORESET_OFF, 0x1);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_APBONLY0_MICROCONTMUXSEL_OFF, 0x0);
...
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_DBYTEDLLMODECNTRL_OFF, 0x2);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY0_P0_OFF, 0x42);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY1_P0_OFF, 0x85);
DDR_W32(APB_DDRPHY_BASE+DWC_DDRPHYA_MASTER0_SEQ0BDLY2_P0_OFF, 0x534);
