...
int ospi_init(storage_device_t *storage_dev, uint32_t res_idx, void *config);
int ospi_read (storage_device_t *storage_dev, uint64_t src, uint8_t *dst, uint64_t size);
uint8_t * ospi_read_ptr(storage_device_t *storage_dev, uint64_t src, uint64_t size);
int ospi_write(storage_device_t *storage_dev, uint64_t dst, const uint8_t *buf, uint64_t data_len);
