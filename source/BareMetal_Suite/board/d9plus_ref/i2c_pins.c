...
const pad_ctrl_t i2c3_pins[] = {
    PIN_DCLR(IOMUXC_SAFE, RGMII1_RXD1, RGMII1_RXD1, SEL_NONE,            /* I2C3.SCL */
             FV_PIN_MUX_CONFIG_MUX(3), PAD_SETTING_I2C, 0),
    PIN_DCLR(IOMUXC_SAFE, RGMII1_RXD2, RGMII1_RXD2, SEL_NONE,            /* I2C3.SDA */
             FV_PIN_MUX_CONFIG_MUX(3), PAD_SETTING_I2C, 0),
    PIN_DCLR_NONE,
};
