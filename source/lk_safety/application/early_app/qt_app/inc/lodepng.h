...
extern const char* LODEPNG_VERSION_STRING1;
...
#ifdef __cplusplus
#if !defined(LODEPNG_NO_COMPILE_CPP) && !defined(LODEPNG_REDUCED_IHDR)
...
typedef unsigned LodePNGDecodeImgSize;
#else
typedef unsigned* LodePNGDecodeImgSize;
#endif
...
*/
unsigned lodepng_decode_memory(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                               const unsigned char* in, size_t insize,
                               LodePNGColorType colortype, unsigned bitdepth);

/*Same as lodepng_decode_memory, but always decodes to 32-bit RGBA raw image*/
unsigned lodepng_decode32(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                          const unsigned char* in, size_t insize);

/*Same as lodepng_decode_memory, but always decodes to 24-bit RGB raw image*/
unsigned lodepng_decode24(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                          const unsigned char* in, size_t insize);
...
*/
unsigned lodepng_decode_file(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                             const char* filename,
                             LodePNGColorType colortype, unsigned bitdepth);

/*Same as lodepng_decode_file, but always decodes to 32-bit RGBA raw image.*/
unsigned lodepng_decode32_file(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                               const char* filename);

/*Same as lodepng_decode_file, but always decodes to 24-bit RGB raw image.*/
unsigned lodepng_decode24_file(unsigned char** out, LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                               const char* filename);
...
extern const LodePNGDecompressSettings lodepng_default_decompress_settings1;
...
const LodePNGCompressSettings lodepng_default_compress_settings1 = {2, 1, DEFAULT_WINDOWSIZE, 3, 128, 1, 0, 0, 0};
...
*/
unsigned lodepng_inspect(LodePNGDecodeImgSize w, LodePNGDecodeImgSize h,
                         LodePNGState* state,
                         const unsigned char* in, size_t insize);
#endif /*LODEPNG_COMPILE_DECODER*/
...
unsigned decompress(std::vector<unsigned char>& out, const unsigned char* in, size_t insize,
                    const LodePNGDecompressSettings& settings = lodepng_default_decompress_settings1);
...
unsigned compress(std::vector<unsigned char>& out, const unsigned char* in, size_t insize,
                  const LodePNGCompressSettings& settings = lodepng_default_compress_settings1);
