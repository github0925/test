...
**
******************************************************************************/
#ifndef QUL_PROCESSORDETECTION_H
#define QUL_PROCESSORDETECTION_H
...
/*
    This file uses preprocessor #defines to set various QUL_PROCESSOR_* #defines
    based on the following patterns:

    QUL_PROCESSOR_{FAMILY}
    QUL_PROCESSOR_{FAMILY}_{VARIANT}
    QUL_PROCESSOR_{FAMILY}_{REVISION}
    ...
    QUL_BYTE_ORDER appropriately for the target processor. For bi-endian
...
#define QUL_BIG_ENDIAN __ORDER_BIG_ENDIAN__
#else
#define QUL_BIG_ENDIAN 4321
#endif
#if defined(__ORDER_LITTLE_ENDIAN__)
#define QUL_LITTLE_ENDIAN __ORDER_LITTLE_ENDIAN__
#else
#define QUL_LITTLE_ENDIAN 1234
#endif
...
// #  define QUL_PROCESSOR_ALPHA
// QUL_BYTE_ORDER not defined, use endianness auto-detection
...
#define QUL_PROCESSOR_ARM_64
#define QUL_PROCESSOR_WORDSIZE 8
#else
#define QUL_PROCESSOR_ARM_32
#endif
#if defined(__ARM_ARCH) && __ARM_ARCH > 1
#define QUL_PROCESSOR_ARM __ARM_ARCH
#elif defined(__TARGET_ARCH_ARM) && __TARGET_ARCH_ARM > 1
#define QUL_PROCESSOR_ARM __TARGET_ARCH_ARM
#elif defined(_M_ARM) && _M_ARM > 1
#define QUL_PROCESSOR_ARM _M_ARM
#elif defined(__ARM64_ARCH_8__) || defined(__aarch64__) || defined(__ARMv8__) || defined(__ARMv8_A__) \
    || defined(_M_ARM64)
#define QUL_PROCESSOR_ARM 8
#elif defined(__ARM_ARCH_7__) || defined(__ARM_ARCH_7A__) || defined(__ARM_ARCH_7R__) || defined(__ARM_ARCH_7M__) \
    || defined(__ARM_ARCH_7S__) || defined(_ARM_ARCH_7) || defined(__CORE_CORTEXA__)
#define QUL_PROCESSOR_ARM 7
...
#define QUL_PROCESSOR_ARM 6
#elif defined(__ARM_ARCH_5TEJ__) || defined(__ARM_ARCH_5TE__)
#define QUL_PROCESSOR_ARM 5
#else
#define QUL_PROCESSOR_ARM 0
#endif
#if QUL_PROCESSOR_ARM >= 8
#define QUL_PROCESSOR_ARM_V8
#endif
#if QUL_PROCESSOR_ARM >= 7
#define QUL_PROCESSOR_ARM_V7
#endif
#if QUL_PROCESSOR_ARM >= 6
#define QUL_PROCESSOR_ARM_V6
#endif
#if QUL_PROCESSOR_ARM >= 5
#define QUL_PROCESSOR_ARM_V5
#else
//#    error "ARM architecture too old"
#endif
#if defined(__ARMEL__) || defined(_M_ARM64)
#define QUL_BYTE_ORDER QUL_LITTLE_ENDIAN
#elif defined(__ARMEB__)
#define QUL_BYTE_ORDER QUL_BIG_ENDIAN
#else
// QUL_BYTE_ORDER not defined, use endianness auto-detection
#endif
...
#define QUL_PROCESSOR_X86_32
#define QUL_BYTE_ORDER QUL_LITTLE_ENDIAN
#define QUL_PROCESSOR_WORDSIZE 4

/*
 * We define QUL_PROCESSOR_X86 == 6 for anything above a equivalent or better
...
#define QUL_PROCESSOR_POWER
#if defined(__ppc64__) || defined(__powerpc64__) || defined(__64BIT__)
#define QUL_PROCESSOR_POWER_64
#define QUL_PROCESSOR_WORDSIZE 8
#else
#define QUL_PROCESSOR_POWER_32
#endif
// QUL_BYTE_ORDER not defined, use endianness auto-detection
...
#define QUL_PROCESSOR_S390
#if defined(__s390x__)
#define QUL_PROCESSOR_S390_X
#endif
#define QUL_BYTE_ORDER QUL_BIG_ENDIAN
...
*/
// #elif defined(__sh__)
// #  define QUL_PROCESSOR_SH
// #  if defined(__sh4a__)
// #    define QUL_PROCESSOR_SH_4A
// #  endif
// QUL_BYTE_ORDER not defined, use endianness auto-detection
...
#define QUL_PROCESSOR_SPARC
#if defined(__sparc_v9__)
#define QUL_PROCESSOR_SPARC_V9
#endif
#if defined(__sparc64__)
#define QUL_PROCESSOR_SPARC_64
#endif
#define QUL_BYTE_ORDER QUL_BIG_ENDIAN
...
#if !defined(QUL_BYTE_ORDER)
#if defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == QUL_BIG_ENDIAN || __BYTE_ORDER__ == QUL_LITTLE_ENDIAN)
// Reuse __BYTE_ORDER__ as-is, since our QUL_*_ENDIAN #defines match the preprocessor defaults
#define QUL_BYTE_ORDER __BYTE_ORDER__
...
/*
   ...
   * If QUL_PROCESSOR_WORDSIZE was defined above, it's assumed to match the pointer
     size.
   Otherwise, we assume to be 32-bit and then check in qglobal.cpp that it is right.
*/

#if defined __SIZEOF_POINTER__
#define QUL_POINTER_SIZE __SIZEOF_POINTER__
#elif defined(__LP64__) || defined(_LP64)
#define QUL_POINTER_SIZE 8
#elif defined(QUL_PROCESSOR_WORDSIZE)
#define QUL_POINTER_SIZE QUL_PROCESSOR_WORDSIZE
#else
#define QUL_POINTER_SIZE 4
#endif

/*
   Define QUL_PROCESSOR_WORDSIZE to be the size of the machine's word (usually,
   ...
   Falls back to QUL_POINTER_SIZE if not set explicitly for the platform.
*/
#ifndef QUL_PROCESSOR_WORDSIZE
#define QUL_PROCESSOR_WORDSIZE QUL_POINTER_SIZE
#endif

#endif // QUL_PROCESSORDETECTION_H
