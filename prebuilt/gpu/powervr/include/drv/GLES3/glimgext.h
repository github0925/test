...
#ifndef GL_IMG_YUV_target_mrt
#define GL_IMG_YUV_target_mrt 1
#define GL_REQUIRED_COLOUR_ATTACHMENT_UNITS_IMG    0x9689
#define GL_FRAMEBUFFER_INCOMPLETE_INSUFFICIENT_ATTACHMENT_RESOURCES_IMG    0x968A
#endif /* GL_IMG_YUV_target_mrt */
