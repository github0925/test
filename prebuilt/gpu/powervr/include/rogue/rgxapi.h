...
{
	IMG_UINT32				ui32ContextFlags;               /*!< Flags which specifiy properties of the context */
	...
	IMG_UINT32				ui32CallStackDepth;				/*!< Number of entries in the VDM Call Stack */
#if defined(FIX_HW_BRN_67349) || defined(FIX_HW_BRN_70353)
	IMG_PUINT32				pui32VDMCtrlStreamBuffer67349;	/*!< Patched VDM control stream */
	IMG_UINT32				ui32VDMCtrlSizeInDWords67349;	/*!< Size of patched VDM control stream in dwords */
#endif
...
typedef struct RGX_RT_CONFIG_RES_TAG
{
...
#if ! defined(RGX_FEATURE_SIMPLE_INTERNAL_PARAMETER_FORMAT)
	IMG_UINT32 ui32MTileX2; /*!< Applied to psRTDataSet->ui32MTileX2 */
	IMG_UINT32 ui32MTileY2; /*!< Applied to psRTDataSet->ui32MTileY2 */
	IMG_UINT32 ui32MTileX3; /*!< Applied to psRTDataSet->ui32MTileX3 */
	IMG_UINT32 ui32MTileY3; /*!< Applied to psRTDataSet->ui32MTileY3 */
#endif
	...
	IMG_UINT32 ui32MTileStride; /*!< Applied to psRTDataSet->ui32MTileStride */
	IMG_UINT32 ui32RgnPageStride; /*!< Applied to psRTDataSet->ui32RgnPageStride */
	IMG_UINT32 ui32TPCStride; /*!< Applied to psRTDataSet->ui32TPCStride */
	IMG_UINT32 ui32MacrotileArraySize; /*!< Applied to psRTDataSet->ui32MacrotileArraySize */
	IMG_UINT32 ui32TEScreen; /*!< Applied to psRTDataSet->ui32TEScreen */
	IMG_UINT32 ui32ScreenPixelMax; /*!< Applied to psRTDataSet->ui32ScreenPixelMax */

#if defined(RGX_HW_REQUIRES_TRIANGLE_MERGING_CONSTANTS)
	...
	IMG_UINT64 ui64MultiSampleCtl; /*!< Applied to psRTDataSet->ui64MultiSampleCtl */
	IMG_UINT64 ui64FlippedMultiSampleCtl; /*!< Applied to psRTDataSet->ui64FlippedMultiSampleCtl */
	...
	IMG_UINT32 ui32RgnHeadersSingleRTSize;
	IMG_UINT32 ui32RgnHeadersScratchOffset;
#endif
} RGX_RT_CONFIG_RES;
...
#if !defined(RGX_FEATURE_SIMPLE_INTERNAL_PARAMETER_FORMAT)
	IMG_DEV_VIRTADDR asMacrotileArrayDevVAddr[RGXMKIF_NUM_RTDATAS]; /*!< DevVAddrs of MTAs (one allocation per RTData) */
#endif
...
/*!< Bit 2 unused: It was used for Z-only render */
...
#define RGX_KICKTA_FLAGS_APPLY_VCE_PAUSE				(1UL << 6)	/*!< Poll on VCE pages inflight reaching 4 */
...
#define RGX_KICKTA_FLAGS_PBE_DISABLE_EDGEOPT			(1UL << 8)	/*!< Disallow PBE edge optimisation */
#endif
...
#define RGX_KICKTA_FLAGS_FLIP_SAMPLE_POSITIONS			(1UL << 11) /*!< Render needs flipped sample positions */
#if defined(FIX_HW_BRN_59998)
#define RGX_KICKTA_FLAGS_TA_WRITE_TEXTURE				(1UL << 13) /*!< Indicate that TA cmd does write operations to textures */
#define RGX_KICKTA_FLAGS_3D_WRITE_TEXTURE				(1UL << 14) /*!< Indicate that 3D cmd does write operations to textures */
#endif
#define RGX_KICKTA_FLAGS_SPMSCRATCHBUFFER				(1UL << 15) /*!< Indicates there is a scratch buffer for SPM */
#if defined(RGX_FEATURE_PAIRED_TILES)
#define RGX_KICKTA_FLAGS_PAIRED_TILES					(1UL << 16) /*!< Indicates paired tile support is in use */
#endif
#if defined(FIX_HW_BRN_65101)
#define RGX_KICKTA_FLAGS_BRN65101						(1UL << 17) /*!< BRN65101 fix */
#define RGX_KICKTA_FLAGS_RENDER_STRIPS_IF_BGOBJ			(1UL << 18) /*!< FW must split render into strips of tiles */
#define RGX_KICKTA_FLAGS_HORIZONTAL_STRIPS				(1UL << 19) /*!< Strips of tiles are horizontal */
#endif
#if defined(FIX_HW_BRN_61484) || defined(FIX_HW_BRN_66333)
#define RGX_KICKTA_FLAGS_BYPASS_BRN61484_BRN66333		(1UL << 20) /*!< Disable BRN61484 and BRN66333 fix */
#endif
#if defined(SUPPORT_STRIP_RENDERING)
#define RGX_KICKTA_FLAGS_FRAME_STRIP					(1UL << 21) /*!< Indicates this is a frame strip */
#endif
#if defined(FIX_HW_BRN_67182)
#define RGX_KICKTA_FLAGS_BRN67182						(1UL << 22) /*!< BRN67182 fix */
#endif
#if !defined(RGX_COMPUTE_OVERLAP_WITH_3D_DISABLED)
#define RGX_KICKTA_FLAGS_PREVENT_COMPUTE_OVERLAP		(1UL << 23) /*!< Prevent CDM from overlapping with this render */
#endif
#if defined(FIX_HW_BRN_69359)
#define RGX_KICKTA_FLAGS_TA_RW_TEXTURE					(1UL << 24) /*!< Indicate that TA cmd does both read and write operations to textures */
#define RGX_KICKTA_FLAGS_3D_RW_TEXTURE					(1UL << 25) /*!< Indicate that 3D cmd does both read and write operations to textures */
#endif /* defined(FIX_HW_BRN_69359) */
#if defined(RGX_FEATURE_GPU_MULTICORE_SUPPORT)
#define RGX_KICKTA_FLAGS_SINGLE_CORE					(1UL << 26)	/*!< Use single core in a multi core setup */
#endif
...
typedef struct RGX_KICKTA_TAG
{
    ...
    IMG_UINT32              ui32ISPAntiAliasMode;           /*!< ISP Anti-Alias Mode */
	IMG_UINT32				ui32ISPCtl;						/*!< ISP Control */


	IMG_UINT32 			ui32PixelOutputWidth;				/*!< Width in DWords of pixel outputs */
	IMG_UINT32			ui32MaxTilesInFlight;				/*!< Upper limit for tiles in flight, '0' means use default limit in Services based on partition store */
...
#if defined(FIX_HW_BRN_51537) && defined(FIX_HW_BRN_44079)
	IMG_BOOL				bNeedManyCoeffs;				/*!< Reconfigure CSRM to support large coeff allocations */
#endif
...
/*! @defgroup       TQ surfaces for rop4 blits
*/
/* @{*/
#define	TQ_MAX_SRC_SURFACES			3U	/*!< maximum number of source textures*/

#define TQ_SRC_SURFACE				0U	/*!< the surface where we read the source from*/
#define TQ_SRC_PATTERN				1U	/*!< the surface where we read the pattern from*/
#define TQ_SRC_MASK					2U	/*!< the surface where we read the mask from*/

#define	TQ_MAX_DST_SURFACES			1U	/*!< maximum number of destination textures*/

#if defined(RGX_FEATURE_PBE_STRIDE_ALIGN_1PIXEL)
#define TQ_MAX_STRIDE_IN_PIXELS_3D      16384U
#else
#define TQ_MAX_STRIDE_IN_PIXELS_3D      8192U
#endif

#define TQ_MAX_STRIDE_IN_PIXELS_TLA		16384U

#define TQ_MAX_PIXELS_VZ_TLA            0 /*!< TLA blit splitting disabled by default in virtualization builds */
#define TQ_MAX_PIXELS_VZ_3D             0 /*!< 3D TQ blit splitting disabled by default in virtualization builds */

/* @}*/

/*! @defgroup       Filter type to use when performing operations
*/
/* @{*/
#define TQ_FILTERTYPE_NONE			0U   /*!< Transfer-Queue Filter Type: None */
#define TQ_FILTERTYPE_POINT			0U   /*!< Transfer-Queue Filter Type: Point */
#define TQ_FILTERTYPE_LINEAR		2U   /*!< Transfer-Queue Filter Type: Linear */
#define TQ_FILTERTYPE_BICUBIC		3U   /*!< Transfer-Queue Filter Type: Bi-cubic */
#define TQ_FILTERTYPE_CUSTOM		4U   /*!< Transfer-Queue Filter Type: Custom */
/* @}*/

/*! @defgroup       Blitter priority selection
*/
/* @{*/
#define TQ_BLITTER_TLA			1U		/*!< blit routed to the TLA hardware*/
#define TQ_BLITTER_3D			2U		/*!< blit routed to the 3D hardware*/

/* default routing fallback list:
 *  - try TLA first
 *  - try 3D core second
 */
#define	TQ_ROUTE_AUTO			0x01020000U	/*!< left to right priority list of the blit routing*/
#define	TQ_ROUTE_ONLY_TLA		0x01000000U	/*!< TLA hardware only*/
#define	TQ_ROUTE_ONLY_3D		0x02000000U	/*!< 3D core only*/
#define TQ_ROUTE_PREFER_3D		0x02010000U	/*!< Prefer 3D core over TLA hardware */
...
*/
/* @{*/
#define TQ_BLIT					0U		/*!< The main blit type. Handles everything apart from the following special cases*/
#define TQ_CLIP					2U		/*!< Clip blit*/
/* @}*/
...
#define TQ_ALPHA_CUSTOM						0x05U		/*!< programmable alpha and rgb blend ops */
#define TQ_ALPHA_AATEXT						0x06U		/*!< Cdst = Csrc*Asrc	+ Cdst*(1-Asrc) const rgb, A8 or A4 source */

/*
	TQ_ALPHA_CUSTOM : blend op flags for ui32CustomRGB and ui32CustomAlpha fields
	output = ([invert]source op * source rgb) + ([invert]dest op * dest rgb)
*/
#define TQ_ALPHA_CUSTOM_SRC_OP_ONE			0x00000000U  /*!< Source Op One */
#define TQ_ALPHA_CUSTOM_SRC_OP_SRC			0x00000001U  /*!< Source Op Source */
#define TQ_ALPHA_CUSTOM_SRC_OP_DST			0x00000002U  /*!< Source Op Dest */
#define TQ_ALPHA_CUSTOM_SRC_OP_SRCGLOB		0x00000003U  /*!< Source Op Source-Global */
#define TQ_ALPHA_CUSTOM_SRC_OP_DSTGLOB		0x00000004U  /*!< Source Op Dest-Global */
#define TQ_ALPHA_CUSTOM_SRC_OP_GLOB			0x00000005U  /*!< Source Op Global */
#define TQ_ALPHA_CUSTOM_SRC_OP_ZERO			0x00000006U  /*!< Source Op Zero */
#define TQ_ALPHA_CUSTOM_SRC_OP_INVERT		0x00000010U  /*!< Source Op Invert */
#define TQ_ALPHA_CUSTOM_DST_OP_ONE			0x00000000U  /*!< Dest Op One */
#define TQ_ALPHA_CUSTOM_DST_OP_SRC			0x00000100U  /*!< Dest Op Source */
#define TQ_ALPHA_CUSTOM_DST_OP_DST			0x00000200U  /*!< Dest Op Dest */
#define TQ_ALPHA_CUSTOM_DST_OP_SRCGLOB		0x00000300U  /*!< Dest Op Source-Global */
#define TQ_ALPHA_CUSTOM_DST_OP_DSTGLOB		0x00000400U  /*!< Dest Op Dest-Global */
#define TQ_ALPHA_CUSTOM_DST_OP_GLOB			0x00000500U  /*!< Dest Op Global */
#define TQ_ALPHA_CUSTOM_DST_OP_ZERO			0x00000600U  /*!< Dest Op Zero */
#define TQ_ALPHA_CUSTOM_DST_OP_INVERT		0x00001000U  /*!< Dest Op Invert */

/* @}*/

/*! Describes an Alpha-Transparency Configuration - for Transfer Queue Use. */
typedef struct TQ_ALPHA_TAG
{
	IMG_UINT32			ui32Type;			/*!< alpha type */
	IMG_UINT32			ui32Global;			/*!< global alpha value */

	IMG_UINT32			ui32CustomRGB;		/*!< custom blend op for rgb */
	IMG_UINT32			ui32CustomAlpha;	/*!< custom blend op for alpha */
	IMG_UINT32			ui32Global2;		/*!< custom global alpha value for alpha output */
	IMG_BOOL			bGlobSrcMul;		/*!< custom multiplication of global and source alpha */
	IMG_BOOL			bZeroSrcATrans;		/*!< custom zero source alpha transparency stage */

	IMG_BOOL			bAlphaComponents;	/*!< enable argb1555 alpha components */
	IMG_UINT32			ui32Component0;		/*!< source alpha value when argb1555 alpha bit is 0 */
	IMG_UINT32			ui32Component1;		/*!< source alpha value when argb1555 alpha bit is 1 */

} TQ_ALPHA; /*!< Typedef for struct _TQ_ALPHA_ */

/*! Provides info about a Pattern Rectangle - for Transfer Queue Use. */
typedef struct TQ_PATTERN_TAG
{
	IMG_UINT32			ui32XStart;			/*!< X offset to the first pixel to read within the pattern rectangle */
	IMG_UINT32			ui32YStart;			/*!< Y offset to the first pixel to read within the pattern rectangle */

} TQ_PATTERN; /*!< Typedef for struct _TQ_PATTERN_ */
...
/*!
  Parameters for a Transfer-Queue Blit Operation
*/
typedef struct TQ_BLIT_OP_TAG
{
	IMG_UINT32        ui32Flags;                     /*!< blt flags*/
	IMG_UINT32        ui32RopCode;                   /*!< 16 bit rop4 (ie two 8 bit rop3's)*/
	IMG_CLEAR_COLOUR  uFillColour;                   /*!< used for fill colour, key colour, and aatext colour */
	IMG_UINT32        ui32ColourMask;                /*!< colour key mask*/
	TQ_ALPHA          sAlpha;                        /*!< alpha blend*/
	TQ_PATTERN        sPattern;                      /*!< pattern offsets*/
} TQ_BLIT_OP; /*!< Convenience typedef for struct _TQ_BLIT_OP_ */


/*! ***********************************************************************//**
@brief          clip blit operation for multiple source/destination rectangles

Clip blit takes a number of source rectangle/destination rectangle mappings for
each source surface specified. The rectangle pairs in each mapping are mapped in
such a way that src rectangle (x0, y0) (x1, y1) on the source surface space refers
to destination rectangle (x0, y0) (x1, y1) on the destination surface.

Flipping rectangle orientation is supported.

The destination rectangle acts as a global clip box on the render.
*/ /**************************************************************************/
...
*/ /**************************************************************************/
typedef struct TQ_CREATE_CONTEXT_TAG
{
	IMG_UINT32          ui32ContextFlags;               /*!< Flags specifying properties of the context */
	PVRSRV_DEVMEMCTX	hDevMemContext;					/*!< Device memory context*/
	IMG_UINT32			ui32SubmitSizeInBytes;			/*!< TQ provides the internal submit size to the client*/
	IMG_UINT32			ui32Priority;					/*!< Context switch priority */
	IMG_CHAR            cClientAPI;                     /*!< A 1 character tag describing client API requesting TQ
	                                                         context, DM's resource tag (ie. TQ3D or TLA) appended
	                                                         to it. Used in naming resources associated with this
	                                                         context, eg. Timeline. */
} TQ_CREATE_CONTEXT;


/*! ***********************************************************************//**
@brief          The submit structure.

Per submit client data. For the size of internal submit data refer to
 * TQ_CREATE_CONTEXT.pui32SubmitSizeInBytes.
*/ /**************************************************************************/
typedef struct TQ_TRANSFER_SUBMIT_TAG
{
	IMG_HANDLE          hTransferIntSubmit;          /*!< internal submit data handle*/
	IMG_UINT32          ui32ChosenBlitter;           /*!< filled in by prepare, the chosen blitter as in ui32Routing packed to the right (LSB) (client writes to are ignored by TQ) */

	PVRSRV_FENCE        iCheckFence; /*!< Fence sync checked before the commands in this submit, or PVRSRV_NO_FENCE */
} TQ_TRANSFER_SUBMIT;
...
*/ /**************************************************************************/
typedef struct TQ_TRANSFER_COMMAND_TAG
{
	IMG_UINT32          ui32Flags;          /*!< flags */
	IMG_UINT32          ui32Frame;          /*!< frame number*/
	IMG_UINT32          ui32Routing;        /*!< blit routing, use TQ_ROUTE_* defines */
	IMG_UINT32          ui32Type;           /*!< type of transfer operation */

	union {
		TQ_BLIT_OP          sBlit;          /*!< Blit Operation Description */
	} Details;                             /*!< operation type specific data*/

	IMG_UINT32                 ui32NumSources;                         /*!< number of source surfaces*/
	TQ_SOURCE                  asSources[TQ_MAX_SRC_SURFACES];         /*!< array of source surfaces*/
	IMG_UINT32                 aui32SampleFilter[TQ_MAX_SRC_SURFACES]; /*!< one of TQ_FILTERTYPE_* */
	IMG_RESOLVE_OP             aeResolveOp[TQ_MAX_SRC_SURFACES];       /*!< MSAA resolve operation */

	IMG_RECT                   sScissor;	/*! a destination scissor rectangle */

	TQ_SURFACE                 sDest;       /*!< the destination surfaces*/
	...
	TQ_TRANSFER_SUBMIT         sTransferSubmit;    /*!< structure that holds the submit information */
} TQ_TRANSFER_COMMAND;
...
/**************************************************************************/ /*!
@Function       RGXCreateTransferContext / RGXCreateTransferContextCCB
@Description    Creates a transfer context.
				RGXCreateTransferContextCCB will use custom CCB size.
...
@Input(for CCB) ui32TQ2DCCBAllocSizeLog2	Optional custom CCB size.
                ui32TQ2DCCBMaxAllocSizeLog2	Might be 0 for default size.
				ui32TQ3DCCBAllocSizeLog2
				ui32TQ3DCCBMaxAllocSizeLog2
@Output         phTransferContext			On success, points to
                                    		the newly-created transfer context.
@Return                                 	PVRSRV_OK on success. Otherwise,
                                        	a PVRSRV_ error code
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR IMG_CALLCONV RGXCreateTransferContext(PVRSRV_DEV_CONNECTION *psDevConnection,
												   TQ_CREATE_CONTEXT *psCreateTransfer,
												   IMG_HANDLE *phTransferContext);
IMG_EXPORT
PVRSRV_ERROR IMG_CALLCONV RGXCreateTransferContextCCB(PVRSRV_DEV_CONNECTION *psDevConnection,
													  TQ_CREATE_CONTEXT *psCreateTransfer,
													  IMG_UINT32		ui32TQ2DCCBAllocSizeLog2,
													  IMG_UINT32		ui32TQ2DCCBMaxAllocSizeLog2,
													  IMG_UINT32		ui32TQ3DCCBAllocSizeLog2,
													  IMG_UINT32		ui32TQ3DCCBMaxAllocSizeLog2,
													  IMG_HANDLE		*phTransferContext);
 ...
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR IMG_CALLCONV RGXDestroyTransferContext(IMG_HANDLE hTransferContext);

/**************************************************************************/ /*!
@Function       RGXSetTransferContextPriority
@Description    Set the priority for the specified transfer context
@Input          psDevConnection         Pointer to Device-Data structure
 ...
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR RGXSetTransferContextPriority(PVRSRV_DEV_CONNECTION *psDevConnection,
											IMG_HANDLE hContext,
											IMG_UINT32 ui32Priority);

/**************************************************************************/ /*!
@Function       RGXSetTransferContextFlags
 ...
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR RGXSetTransferContextFlags(PVRSRV_DEV_CONNECTION *psDevConnection,
										IMG_HANDLE            hContext,
										IMG_UINT32            ui32ContextFlags);

/**************************************************************************/ /*!
@Function       RGXQueueTransfer
@Description    Handles the queue transfer request

@Input          hTransferContext The context created by CreateTransferContext()
@Input          psQueueTransfer  The transfer operation supplied by the client
@Output         piUpdateFence    The returned update fence,
                                 or PVRSRV_NO_FENCE_PTR
@Input          pszFenceName     Name to assign to the created update fence,
                                 or PVRSRV_NO_FENCE_PTR
@Return                          PVRSRV_OK on success. Otherwise, a PVRSRV_
                                 error code
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR IMG_CALLCONV RGXQueueTransfer(IMG_HANDLE hTransferContext,
										  TQ_TRANSFER_COMMAND *psQueueTransfer,
										  PVRSRV_FENCE *piUpdateFence,
										  const IMG_CHAR *pszFenceName);

/**************************************************************************/ /*!
@Function       RGXSubmitTransfer
@Description    Transfer UM/KM submission.

@Input          hTransferContext        handle to a transfer context
@Input          psSubmitTransfer        Parameters detailing the Transfer-Queue
                                        Submission
@Output         piUpdateFence           The returned update fence,
                                        or PVRSRV_NO_FENCE_PTR
@Input          pszFenceName            Name to assign to the created update fence,
 ...
 */ /**************************************************************************/
IMG_EXPORT
PVRSRV_ERROR IMG_CALLCONV RGXSubmitTransfer(IMG_HANDLE          hTransferContext,
											TQ_TRANSFER_SUBMIT *psSubmitTransfer,
											PVRSRV_FENCE       *piUpdateFence,
											const IMG_CHAR     *pszFenceName);

/**************************************************************************/ /*!
@Function       RGXQueueValidate
@Description    Validate a queue transfer operation

@Input          psQueueTransfer  The transfer operation supplied by the client
@Return                          Supported transfer operation
                                 0 (for none), TQ_BLITTER_3D and/or TQ_BLITTER_TLA
 */ /**************************************************************************/
IMG_EXPORT
IMG_UINT32 IMG_CALLCONV RGXQueueValidate(const TQ_TRANSFER_COMMAND *psQueueTransfer);

/**************************************************************************/ /*!
@Function       RGXSurfaceAlignment
@Description    Minimum virtual address alignment for a TQ surface.

@Input          psSurface  The TQ surface
@Return                    Minimum virtual address alignment in bytes
 */ /**************************************************************************/
IMG_EXPORT
IMG_UINT32 IMG_CALLCONV RGXSurfaceAlignment(const TQ_SURFACE *psSurface);
...
typedef struct RGX_CREATECOMPUTECONTEXT_TAG
{
	...
	IMG_DEV_VIRTADDR		sPDSSyncDevVAddr;	/*!< Address for PDS-CDM synchronisation on context switch */
#endif
...
@Description    Set the property flags for the given compute context
@Input          psDevConnection         A Device-Data structure
@Input          psContext               Handle to a Compute Context
@Input          ui32Flags               New value for the property flags
@Return                                 PVRSRV_OK on success. Otherwise, a PVRSRV_
                                        error code
 */ /**************************************************************************/
IMG_EXPORT
