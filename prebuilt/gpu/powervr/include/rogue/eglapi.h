...
typedef struct EGLPixelBEState_TAG
{
	...
	IMG_DEV_VIRTADDR	uSPMPixelEventPDSData[IMG_MAX_PARALLEL_RENDERS];
...
#define EGL_MAX_PDS_PPP_STATE_WORDS			7
...
#if IMG_OPT_ENABLED(1_12, FBC_D24S8)
	IMG_BOOL			bD24S8;
#endif
...
#if defined(IMG_EMULATED_LARGE_TEXTURE_SUPPORT)
typedef struct EGLParallelRenderRegSetupTAG
{
	IMG_UINT32 ui32EventPixelPDSData;
#if defined(FIX_HW_BRN_65101)
	IMG_UINT32	ui32BRN65101EventPixelPDSData;
#endif
...
typedef struct EGLRenderSurfaceTAG
{
	...
	IMG_UINT32			aui32PDSPPPStateWords[EGL_MAX_PDS_PPP_STATE_WORDS];
	...
	/* TA-side state */
	IMG_BOOL			bHasDrawcallsWithGSInCurrentTA;
	...
	IMG_BOOL			bNeedManyCoeffs;
#endif

	IMG_UINT32			ui32MaxTilesInFlight;
	...
	void        *pvDepthAttachment;
	void        *pvStencilAttachment;
	...
	IMG_BOOL bDisablePBEEdgeOpt;
#endif

#if defined(FIX_HW_BRN_65101)
	MSAAScratchBuffer sBRN65101ScratchBuffer;
	IMG_BOOL bRequiresStripRenderingIfBGOBJ;
#endif
	...
	IMG_UINT32 ui32MaxCoeffs;
#endif

#if defined(IMG_EMULATED_LARGE_TEXTURE_SUPPORT)
	EGLParallelRenderRegSetup sParallelRenderRegs[IMG_MAX_PARALLEL_RENDERS];
#endif
...
typedef struct EGLDrawableParamsTAG
{
	...
	/* Set to non-zero if the rendering should be offset.
	 * Setting these offsets the viewport/clips etc., and also corrects gl_FragCoord.
	 * Used to compensate for PBE rotation error and for emulated large texture rendering.
	 */
...
typedef struct IMGEGLImageRec
{
...
#if defined(RGX_FBCDC_HW_USES_ADDRESS_OF_DATA_SECTION)
	/* Byte offset from start of underlying allocation to data section.
	 * This is already applied to the virtual address in the meminfo */
	IMG_UINT32				ui32FBDataOffset;
#endif
	...
	PVRSRV_MEMINFO          *psFBCStateMemInfo;
	IMG_UINT32              ui32OffsetFBCType;
} IMGEGLImage;
...
#if defined(HW_ERN_41947)
	IMG_BOOL	bExternalZBufferD24S8;
#endif
...
__must_check IMG_BOOL IMG_CALLCONV KEGLGetPoolBuffers(EGLRenderSurface *psRenderSurface, IMG_UINT32 ui32HWPerfClientFilterCached, void (*pfnGetHWPerfInfo)(void*), RMContext *psRMCtx, IMG_UINT32 ui32NumParallelBuffers);
